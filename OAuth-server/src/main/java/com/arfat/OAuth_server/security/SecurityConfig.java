package com.arfat.OAuth_server.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http)
        ...
        http
                ...
                .authorizeHttpRequests((authorize) ->
                        authorize
                                //TODO: restrict to kubernetes user
    ...
    @Bean
    @Order(2)
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http, TenantConfigurationProperties tenantProperties)
            throws Exception {
        http
    ...
    public RegisteredClientRepository registeredClientRepository(PasswordEncoder encoder) {
        RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://localhost:3000/security/api/auth/callback/oidc")
